        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          ...
          <div className="mt-16 max-w-5xl mx-auto">
            <div className="bg-white rounded-2xl shadow-2xl p-4 border border-slate-200">
              <img src="https://fiverr-res.cloudinary.com/image/upload/f_auto,q_auto/v1/secured-attachments/messaging_message/attachment/eabcb47ca22a502138147e297284b3b4-1754693147616/Dynamic%20Agreement%20Workflow.png?__cld_token__=exp=1754753271~hmac=974994b5da2b3b0f47c3f3926d36a748af99491b1d999fbbc0d3146cfd62c1af" alt="E- Lex Signature Dashboard showing a seamless digital workflow" className="rounded-xl w-full h-auto" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-slate-100 p-8 rounded-2xl">
              <img src="https://fiverr-res.cloudinary.com/image/upload/f_auto,q_auto/v1/secured-attachments/messaging_message/attachment/eabcb47ca22a502138147e297284b3b4-1754693147607/Transparent%20Pricing%20Model.png?__cld_token__=exp=1754753271~hmac=1630aa020c90f3e9ce5338130ac5c4a8bf02cf4ce0f33b51c693c2b3f77144ec  " alt="Illustration of a clear and simple pricing chart" className="rounded-xl shadow-lg w-full h-auto" />
            </div>
          </div>
        </div>
      </section>
