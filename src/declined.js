...
// export default function DeclinedComponent() {
...
//       const response = await axios.get(`${BASE_URL}/getDeclinedDocs`, {
...
//         toast.error(error?.response?.data?.error,{containerId:'declined'})
//       }else{
//         toast.error("Something went wrong please try again",{containerId:"declined"})
//       }
...
//   }catch(e){
// toast.error("Unable to download at the moment",{containerId:"declined"})
//   }
//   };
...
//        toast.success("Document deleted sucessfully",{containerId:"declined"})
//         fetchCompletedRequests();
//       } catch (err) {
//         if(err?.response?.data?.error){
//           toast.error(err?.response?.data?.error,{containerId:"declined"})
//         }else{
//           toast.error("Something went wrong please try again",{containerId:"declined"})
//         }
...
//   return (
//     <>
//     <ToastContainer containerId={"declined"}/>
...
import { BASE_URL } from "./baseUrl"; // if others use "../baseUrl", align as needed
import { toast, ToastContainer } from "react-toastify";

export default function DeclinedComponent() {
  // get shared filters from DocumentsLayout
  ...
  // ---------------- FILTER LOGIC (searchText, dateRange, senderFilter) ----------------
  ...
  // ---------------- Existing handlers: download, view signers, delete ----------------
