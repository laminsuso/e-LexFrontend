...
const SignYourselfPage = () => {
  ...
  const [containerDimensions, setContainerDimensions] = useState({ width: 800, height: 0 });
    ...
    <>
      ...
      <div className="admin-content h-full">
        {step === 1 ? (
          ...
          <div
            className={`flex min-h-screen lg:flex-row flex-col gap-[10px] bg-gray-100 ${draggedElement ? 'prevent-scroll' : ''}`}
          ...
          >
            <div className={`flex-1 p-4 overflow-auto relative ${isMobile ? 'w-full' : ''}`}>
              <button
                ...
                <div className="pdf-container">
                  ...
                  >
                    <Page
                      ...
                      width={isMobile ? window.innerWidth - 32 : Math.min(containerDimensions.width, 800)}
              ...
              {signatureElements.map((element) => (
                <div
                  key={element.id}
                  className={`absolute cursor-move ${draggedElement === element.id ? 'dragging-element' : ''}`}
                  style={{
                    left: `${element.x}px`,
                    top: `${element.y}px`,
                  ...
                  onTouchStart={isMobile ? (e) => handleDragStart(e, element.id) : undefined}
                >
            ...
            <div className={`bg-white p-4 shadow-lg overflow-y-auto ${isMobile ? 'w-full h-auto' : 'w-80'}`}>
                ...
                <div>
                  <div className="border-b pb-4">
                    ...
                    <div
                      ...
                      draggable={!isMobile}
                      onDragStart={!isMobile ? handleToolDragStart('name') : undefined}
                      onTouchStart={isMobile ? handleToolTouchStart('name') : undefined}
                    ...
                    <div
                      ...
                      draggable={!isMobile}
                      onDragStart={!isMobile ? handleToolDragStart('jobTitle') : undefined}
                      onTouchStart={isMobile ? handleToolTouchStart('jobTitle') : undefined}
                      onTouchMove={isMobile ? handleToolTouchMove : undefined}
                      onTouchEnd={isMobile ? handleToolTouchEnd : undefined}
                      style={{ touchAction: 'none' }}
                    >
                    ...
                    <div
                      className="tool-item p-2 mb-2 bg-gray-100 cursor-move"
                      draggable={!isMobile}
                      onDragStart={!isMobile ? handleToolDragStart('company') : undefined}
                      onTouchStart={isMobile ? handleToolTouchStart('company') : undefined}
                      onTouchMove={isMobile ? handleToolTouchMove : undefined}
                      onTouchEnd={isMobile ? handleToolTouchEnd : undefined}
                      style={{ touchAction: 'none' }}
                    >
                    ...
                    <div
                      className="tool-item p-2 mb-2 bg-gray-100 cursor-move"
                      draggable={!isMobile}
                      onDragStart={!isMobile ? handleToolDragStart('email') : undefined}
                      onTouchStart={isMobile ? handleToolTouchStart('email') : undefined}
                      onTouchMove={isMobile ? handleToolTouchMove : undefined}
                      onTouchEnd={isMobile ? handleToolTouchEnd : undefined}
                      style={{ touchAction: 'none' }}
                    >
                    ...
                    <div
                      className="tool-item p-2 mb-2 bg-gray-100 cursor-move select-none"
                      draggable={!isMobile}
                      onDragStart={!isMobile ? handleToolDragStart('date') : undefined}
                      onTouchStart={isMobile ? handleToolTouchStart('date') : undefined}
                      onTouchMove={isMobile ? handleToolTouchMove : undefined}
                      onTouchEnd={isMobile ? handleToolTouchEnd : undefined}
                      style={{ touchAction: 'none' }}
                    ...
                    <div
                      className="tool-item p-2 mb-2 bg-gray-100 cursor-move"
                      draggable={!isMobile}
                      onDragStart={!isMobile ? handleToolDragStart('checkbox') : undefined}
                      onTouchStart={isMobile ? handleToolTouchStart('checkbox') : undefined}
                      onTouchMove={isMobile ? handleToolTouchMove : undefined}
                      onTouchEnd={isMobile ? handleToolTouchEnd : undefined}
                      style={{ touchAction: 'none' }}
                    >
                  ...
                  <div className="border-b pb-4">
                    ...
                    <div
                      className="tool-item p-2 mb-2 bg-gray-100 cursor-move select-none"
                      draggable={!isMobile}
                      onDragStart={!isMobile ? handleToolDragStart('signature') : undefined}
                      onTouchStart={isMobile ? handleToolTouchStart('signature') : undefined}
                      onTouchMove={isMobile ? handleToolTouchMove : undefined}
                      onTouchEnd={isMobile ? handleToolTouchEnd : undefined}
                      style={{ touchAction: 'none' }}
                    >
            ...
            {selectedTool === 'signature' && (
              <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                <div className={`bg-white p-6 rounded-lg ${isMobile ? 'w-11/12' : 'w-96'}`}>
