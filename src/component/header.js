...
export default function Header() {
    ...
    return (
        <div className="w-full flex justify-between lg:h-[150px] bg-[#0f012b] items-center py-[10px] lg:px-[20px] px-[10px] relative">

            <a href="/" className="max-w-[250px] flex gap-2 justify-center items-center text-white">
            ...
            <div className="hidden md:flex gap-[20px] items-center">
                <Link to="/" className={` transition-colors px-[10px] py-[12px] ${currentPath === "/" ? "text-[#10002e] bg-white" : "text-white"}`}>
                    Home
                </Link>

                <Link to="/pricing" className={`transition-colors px-[10px] py-[12px] ${currentPath === "/pricing" ? "text-[#10002e] bg-white" : "text-white"}`}>
                    Pricing
                </Link>
                <Link to="/contact" className={` transition-colors px-[10px] py-[12px] ${currentPath === "/contact" ? "text-[#10002e] bg-white" : "text-white"}`}>

                    Contact
                </Link>
                <Link to="/join" className={` transition-colors px-[10px] py-[12px] ${currentPath === "/join" ? "text-[#10002e] bg-white" : "text-white"}`}>
            ...
            <div className={`fixed top-0 left-0 h-full w-64 bg-[#0f012b] z-50 transform transition-transform duration-300
            ...
            >
                <div className="p-6 flex flex-col gap-6">
                    ...
                    <Link
                        to="/"
                        className={`px-[10px] py-[12px] ${currentPath === "/" ? "text-[#10002e] bg-white" : "text-white"}`}
                        onClick={() => setIsMenuOpen(false)}
                    >
                        Home
                    </Link>
                    <Link
                        to="/resources"
                        className={`px-[10px] py-[12px] ${currentPath === "/resources" ? "text-[#10002e] bg-white" : "text-white"}`}
                        onClick={() => setIsMenuOpen(false)}
                    >
                        Resources
                    </Link>
                    <Link
                        to="/pricing"
                        className={`px-[10px] py-[12px] ${currentPath === "/pricing" ? "text-[#10002e] bg-white" : "text-white"}`}
                        onClick={() => setIsMenuOpen(false)}
                    >
                        Pricing
                    </Link>
                    ...
                    <Link
                        to="/contact"
                        className={`px-[10px] py-[12px] ${currentPath === "/contact" ? "text-[#10002e] bg-white" : "text-white"}`}
                        onClick={() => setIsMenuOpen(false)}
                    >
                        Contact
                    </Link>
